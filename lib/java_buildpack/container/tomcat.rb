...
require 'java_buildpack/container/tomcat/tomcat_jar_support'
    ...
    class Tomcat < JavaBuildpack::Component::ModularComponent
      ...
      def sub_components(context)
        [
          ...
          TomcatJarSupport.new(sub_configuration_context(context, 'jar_support')),
          TomcatJarSupport.new(sub_configuration_context(context, 'jar_support1')),
